 ...
 "cells": [
  {
   ...
   "source": [
    "\n",
    "#Media analysis: Observations & experiments\n",
    "\n",
    "Okay, so here it is - my first Jupyter notebook. \n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "So, starting off, I want to test out how we can observe media quickly. \n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Phew, that seemed to work but the render is not pretty at all. \n",
    "It is something like a lot of blob of this:\n",
